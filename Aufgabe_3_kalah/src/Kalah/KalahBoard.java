...
public class KalahBoard {
	...
	/*
	 * Board als Feld. 
	 * APlayer: 0,1,2,3,4,5    und A-Kalah.Kalah 6
	 * BPlayer: 7,8,9,10,11,12 und B-Kalah.Kalah 13
	 */
	...
	/**
	 *	Konstruktor.
	 *  Legt eine Kalah.Kalah-Board mit NMulden mit je NSteine an.
	 */
	public KalahBoard() {
	...
	/**
	 * Liefert Kalah.Kalah von Spieler A.
	 * @return Kalah.Kalah von Spieler A.
	 */
	...
	/**
	 * Liefert Kalah.Kalah von Spieler B.
	 * @return Kalah.Kalah von Spieler B.
	 */
	 ...
	 * Gegnerische Steine werden dann ins Kalah.Kalah gelegt.
	...
	public int readAction() {
		...
		if(curPlayer == APlayer) {
			return Alpha_Beta_Pruning.miniMax(this, 7);
		}
